...
%	\includegraphics[width=115mm]{figure-7.pdf}
	\caption{Calibrated zonal extents (in degrees) of the spatial windows for the different methods and reanalyses and for all stations. Same conventions as Fig. \ref{fig:params-nb-analogs}.}
...
%	\includegraphics[width=115mm]{figure-8.pdf}
	\caption{Calibrated meridional extents (in degrees) of the spatial windows for the different methods and reanalyses and for all stations. Same conventions as Fig. \ref{fig:params-nb-analogs}.}
